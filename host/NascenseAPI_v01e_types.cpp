...
const std::map<int, const char*> _emSequenceOperationType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(7, _kemSequenceOperationTypeValues, _kemSequenceOperationTypeNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
...
const char* emSequenceItem::ascii_fingerprint = "36477F2D2CDBB67F6A3FFEFE40580BC0";
const uint8_t emSequenceItem::binary_fingerprint[16] = {0x36,0x47,0x7F,0x2D,0x2C,0xDB,0xB6,0x7F,0x6A,0x3F,0xFE,0xFE,0x40,0x58,0x0B,0xC0};
