...
class emSequenceItem {
 public:
  ...
  static const char* ascii_fingerprint; // = "36477F2D2CDBB67F6A3FFEFE40580BC0";
  static const uint8_t binary_fingerprint[16]; // = {0x36,0x47,0x7F,0x2D,0x2C,0xDB,0xB6,0x7F,0x6A,0x3F,0xFE,0xFE,0x40,0x58,0x0B,0xC0};

  emSequenceItem() : operationType((emSequenceOperationType::type)0), startTime(0), endTime(0), frequency(0), phase(0), cycleTime(0), amplitude(0), waveFormType((emWaveFormType::type)0), waitForTrigger(-1) {
  }
