...
xst -ifn xst.scr
move main_clocks_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\main_clocks_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc main_clocks_exdes.ucf main_clocks_exdes

echo 'Running map'
map -timing -pr b main_clocks_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm main_clocks_exdes -w routed.ncd routed.v
cd ..
