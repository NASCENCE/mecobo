...
namespace EMServer
{
    public class emWaveFormUtilities
    {
        ...
        public static emWaveForm absDifference(emWaveForm emWaveForm1, emWaveForm emWaveForm2)
        {
        ...
        public static double sum(emWaveForm emWaveForm)
        {
            double Acc = 0;
        ...
        public static double sumSquaredDifference(emWaveForm emWaveForm1, emWaveForm emWaveForm2)
        {
            if (emWaveForm1.SampleCount != emWaveForm2.SampleCount)
            {
                emException Err = new emException();
        ...
        public static emWaveForm add(emWaveForm emWaveForm1, emWaveForm emWaveForm2)
        {
            if (emWaveForm1.SampleCount != emWaveForm2.SampleCount)
            {
                emException Err = new emException();
        ...
        public static emWaveForm subtract(emWaveForm emWaveForm1, emWaveForm emWaveForm2)
        {
            if (emWaveForm1.SampleCount != emWaveForm2.SampleCount)
            {
                emException Err = new emException();
        ...
        public static void setValues(emWaveForm emWaveForm, int value)
        {
        ...
        public static emWaveForm threshold(emWaveForm emWaveForm, int thresholdValue, int maxValue, bool invert)
        {
            emWaveForm R = new emWaveForm();
        ...
        public static void minMax(emWaveForm emWaveForm, out int minValue, out int maxValue)
        {
        ...
        public static emWaveForm normalize(emWaveForm emWaveForm, int minValue, int maxValue)
        {
        ...
        public static List<double> normalize(emWaveForm emWaveForm, double minValue, double maxValue)
        {
            int emWaveFormMin; int emWaveFormMax;
            minMax(emWaveForm, out emWaveFormMin, out emWaveFormMax);
        ...
        public static emWaveForm quantize(emWaveForm emWaveForm, int minValue, int maxValue, int levels)
        {
            throw new NotImplementedException();
        }

        public static emWaveForm resample(emWaveForm emWaveForm, int newLength)
        {
            throw new NotImplementedException();
        }

        public static emWaveForm medianFilter(emWaveForm emWaveForm, int filterSize)
        {
            emWaveForm R = new emWaveForm();
            R.SampleCount = emWaveForm.SampleCount;
            R.Rate = emWaveForm.Rate;
