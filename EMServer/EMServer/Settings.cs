...
namespace EMServer
{
    public class Settings
    {
        ...
        {
            SetSetting<bool>("LogServer", true);
            SetSetting<string>("LogServerPath", "./serverlog");
            SetSetting<bool>("LogClient", true);
            SetSetting<string>("LogClientPath", "./clientlog");
            SetSetting<string>("Server", "win8laptop-slh");
            SetSetting<int>("ServerPort", 9090);
            SetSetting<string>("DataAPIServer", "win8laptop-slh");
            SetSetting<int>("DataAPIServerPort", 9091);
        }
        ...
        public static string DefaultSettingsFileName = "defaultsettings.conf";
