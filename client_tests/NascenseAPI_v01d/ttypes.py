...
class emSequenceItem:
  ...
  Attributes:
   ...
   - pin: Where the action is applied to (FPGA pin)
  ...
  def __init__(self, operationType=None, pin=None, startTime=None, endTime=None, frequency=thrift_spec[5][4], phase=thrift_spec[6][4], cycleTime=thrift_spec[7][4], amplitude=thrift_spec[8][4], waveFormType=None, waveForm=None, waitForTrigger=thrift_spec[11][4],):
  ...
  def write(self, oprot):
    ...
    if self.pin is not None:
      oprot.writeFieldBegin('pin', TType.I32, 2)
